...
public enum Category {
    DEVELOPMENT_PROGRAMMING("개발 · 프로그래밍", WEB_DEVELOPMENT, FRONT_END, BACK_END, FULL_STACK,MOBILE_APP_DEVELOPMENT,SubCategory.GAME_DEVELOPMENT,PROGRAMMING_LANGUAGE,ALGORITHM_DATA_STRUCTURE,DATABASE,DEVOPS_INFRASTRUCTURE,CERTIFICATE,DEVELOPMENT_TOOL),
    ...
    GAME_DEVELOPMENT("게임 개발",GAME_PROGRAMMING,GAME_PLANNING,GAME_ART_GRAPHICS,ETC,CHUNGKANG_UNIVERSITY_GAME_SCHOOL),
